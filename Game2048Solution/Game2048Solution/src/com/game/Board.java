...
public class Board extends Group {
    ...
    private void createScore() {
        ...
        if(Game2048.STEP>=3){
            ...
            hScores.getChildren().addAll(vScore);
            VBox vFill = new VBox();
        ...
        // TO-DO: Step 33. bind lblPoints  to gameMovePoints 
        if(Game2048.STEP>=33){
    ...
    public void addTile(SlidingTiles tile){
    ...
    public void moveTile(SlidingTiles tile, Location location){
    ...
    private void initGameProperties() {
        ...
        if(Game2048.STEP>=39){
            ...
            bTry.setOnAction(e->{
                ...
                gridGroup.getChildren().removeIf(c->c instanceof SlidingTiles);
                resetGame.set(false);
